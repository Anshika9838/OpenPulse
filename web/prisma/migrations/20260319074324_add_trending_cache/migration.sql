...
CREATE TABLE "Post" (
    ...
    "mediaUrl" TEXT,
    "tags" TEXT NOT NULL,
    "type" TEXT NOT NULL DEFAULT 'REPOSITORY',
...
CREATE TABLE "Star" (
    ...
    CONSTRAINT "Star_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Star_userId_postId_key" ON "Star"("userId", "postId");
